...
public class JavaDockerCodeSandBox implements CodeSandBox {
    ...
    private static final String SECURITY_MANAGER_PATH = "D:\\code\\wkoj-code-sandbox\\src\\main\\resources\\security";
    ...
    public ExecuteCodeResponse executeCode(ExecuteCodeRequest executeCodeRequest) {
        ...
        for (String inputArgs : inputList) {
            ...
            runCmd = String.format("java -Xmx256m -Dfile.encoding=UTF-8 -cp %s;%s -Djava.security.manager=%s Main %s", userCodeParentPath, SECURITY_MANAGER_PATH, SECURITY_MANAGER_CLASS_NAME, inputArgs);
            try {
